...
public interface OnMidiInputEventListener {
    ...
    /**
     * Raw MIDI Message with 2 bytes data
     * This method doesn't treat `SysEx' messages.
     *
     * @param sender the Object which the event sent
     * @param cable  the cable ID 0-15
     ...
     */
    void onMidiMessage(@NonNull MidiInputDevice sender, int cable, int status, int data1, int data2);
}
