...
public class UsbMidiDriverSampleActivity extends Activity {
	...
	@Nullable Midi2OutputDevice getMidi2OutputDeviceFromSpinner() {
        if (deviceSpinner != null && deviceSpinner.getSelectedItemPosition() >= 0 && connectedDevicesAdapter != null && !connectedDevicesAdapter.isEmpty()) {
            UsbDevice device = connectedDevicesAdapter.getItem(deviceSpinner.getSelectedItemPosition());
            if (device != null) {
                Set<Midi2OutputDevice> midi2OutputDevices = usbMidiDriver.getMidi2OutputDevices(device);

                if (midi2OutputDevices.size() > 0) {
                    // returns the first one.
                    return (Midi2OutputDevice) midi2OutputDevices.toArray()[0];
                }
            }
        }
        return null;
            ...
            public void onMidiOutputDeviceAttached(@NonNull final MidiOutputDevice midiOutputDevice) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(UsbMidiDriverSampleActivity.this, "USB MIDI 1.0 Device " + midiOutputDevice.getUsbDevice().getDeviceName() + " has been attached.", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onMidi2OutputDeviceAttached(@NonNull final Midi2OutputDevice midiOutputDevice) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(UsbMidiDriverSampleActivity.this, "USB MIDI 2.0 Device " + midiOutputDevice.getUsbDevice().getDeviceName() + " has been attached.", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onMidiOutputDeviceDetached(@NonNull final MidiOutputDevice midiOutputDevice) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(UsbMidiDriverSampleActivity.this, "USB MIDI 1.0 Device " + midiOutputDevice.getUsbDevice().getDeviceName() + " has been detached.", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onMidi2OutputDeviceDetached(@NonNull final Midi2OutputDevice midiOutputDevice) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(UsbMidiDriverSampleActivity.this, "USB MIDI 2.0 Device " + midiOutputDevice.getUsbDevice().getDeviceName() + " has been detached.", Toast.LENGTH_LONG).show();
                    }
                });
            }
